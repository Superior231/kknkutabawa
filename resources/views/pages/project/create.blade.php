...
@section('content')
    <div class="container px-0 px-md-3 px-lg-5">
        ...
        <form action="{{ route('project.store') }}" method="POST" class="gap-3 d-flex flex-column" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card">
                <div class="p-3 card-body p-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="category-select" multiple="multiple" name="category[]"
                            style="width: 100%;">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                            id="title" placeholder="Masukkan judul" value="{{ old('title') }}" required>
                        @error('title')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
