                ...
                <div class="p-3 card-body p-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type-select" multiple="multiple" name="type[]"
                            ...
                            @foreach ($types as $type)
                                <option value="{{ $type->name }}" {{ in_array($type->name, explode(', ', $budget->type)) ? 'selected' : '' }}>{{ $type->name }}</option>
                            @endforeach
                        </select>
                        <input type="hidden" name="type" id="type-input" value="{{ $budget->type }}" required>
                        @error('type')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                id="name" name="name" value="{{ $budget->name }}" required>
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('price_out') is-invalid @enderror"
                                id="price_out" name="price_out" value="{{ number_format($budget->price_out, 0, ',', '.') }}"
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('quantity') is-invalid @enderror"
                                id="quantity" name="quantity" value="{{ $budget->quantity }}" required>
                            @error('quantity')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mb-3">
                        <div id="editor-container">
                            ...
                            <textarea name="description" style="height: 150px;" id="description" class="form-control @error('description') is-invalid @enderror">{{ $budget->description }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
