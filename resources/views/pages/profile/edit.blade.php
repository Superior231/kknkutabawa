                ...
                <div class="p-3 card-body p-lg-4">
                    ...
                    <div class="user d-flex align-items-center justify-content-center">
                        <div class="avatar" style="width: 100px; height: 100px;">
                            @if (Auth::user()->avatar)
                                <img src="{{ asset('storage/avatars/' . Auth::user()->avatar) }}" alt="avatar" id="image-preview">
                            @else
                                <img src="https://ui-avatars.com/api/?background=random&name={{ urlencode(Auth::user()->fullname) }}" alt="avatar" id="image-preview">
                            @endif
                        </div>
                    </div>
                    <div class="mb-3">
